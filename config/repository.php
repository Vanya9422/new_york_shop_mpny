...
use App\Repositories\V1\{
    Admin\Commercial\BusinessRepository,
    ...
    Admin\Commercial\PeriodOfStayRepository,
    Admin\Commercial\PeriodOfStayRepositoryEloquent,
...
return [
    'repositories' => [
        'V1' => [
            ...
            PeriodOfStayRepository::class => PeriodOfStayRepositoryEloquent::class,
